...
$$\widehat{\text{weight}} = 7.27 - 0.59 \times \text{habitsmoker}$$
...
"parsim", or the proportion of parasites shared between species.
...
The graph shows a strong negative relationship between divergence time and parasite similarity. As divergence time increases, parasite similarity increases, so closely related primates tend to share more primates than distantly related ones. However, there is a lot more variability in species with more recent divergence times, which means there are other factors than evolutionary history that can make parasite similarity differ.
