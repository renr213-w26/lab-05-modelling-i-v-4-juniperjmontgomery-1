...
ggplot(gapminder_07, aes(x = gdpPercap, y = lifeExp)) +
  ...
  labs(
    ...
    y = "Life Expantacy at Birth (years)",
...
-   What are your general take-aways from how this presentation was given?
  ...
  I enjoyed Rosling's engagement and enthusiasm for statistics that he brought the audience along with building the graph. The visuals made it easier to understand historical trends, while breaking down the countries into provinces disrupted the narrative of general country status, especially in large countries like China that encompass so much territory and economic diversity.
